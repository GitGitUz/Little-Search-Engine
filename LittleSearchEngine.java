...
public class LittleSearchEngine {
	...
	private String removeEndPunc(String word)
	{
		int cnt = 0;
	...
	private boolean onlyCharactersInWord(String word)
	{
		int count = 0;
		boolean b = true;
	...
	public ArrayList<Integer> insertLastOccurrence(ArrayList<Occurrence> occs) {
		...
		occs.add(mPoints.get(mPoints.size()-1), tmp);
	...
	public ArrayList<String> top5search(String kw1, String kw2) {
		...
		ArrayList<Occurrence> ocA1 = new ArrayList<Occurrence>();
		ArrayList<Occurrence> ocA2 = new ArrayList<Occurrence>();
		ArrayList<Occurrence> combination = new ArrayList<Occurrence>();
		
		if (keywordsIndex.containsKey(kw1)){
			ocA1 = keywordsIndex.get(kw1);
		}
		
		if (keywordsIndex.containsKey(kw2)){
			ocA2 = keywordsIndex.get(kw2);
		}
		
		combination.addAll(ocA1);
		combination.addAll(ocA2);
		
		if (!(ocA1.isEmpty()) && !(ocA2.isEmpty()))
		{
